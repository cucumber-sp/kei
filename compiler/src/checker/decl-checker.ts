...
export class DeclarationChecker {
  ...
  constructor(checker: Checker, lifecycle: Lifecycle) {
    ...
    this.structChecker = new StructChecker(checker, lifecycle);
  ...
  /** Delegate to {@link StructChecker.runLifecycleDecide}. */
  runLifecycleDecide(declarations: Declaration[]): void {
    this.structChecker.runLifecycleDecide(declarations);
  }
